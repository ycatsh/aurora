...
async def on_command_error(ctx, error):
    ...
    if isinstance(error, commands.MissingPermissions):
        ...
        Finthechat.add_field(name="Error", value="Please mention a user\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.send(embed=Finthechat)
    elif isinstance(error, commands.MissingRequiredArgument):
        if ctx.command.name == "findnum":
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="please enter a valid number between 1 to 10 (not decimal)\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=Finthechat)
        elif ctx.command.name == "8ball":
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="please type down a message after the ``.8ball``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.reply(embed=Finthechat, mention_author = False)
        elif ctx.command.name == "dp":
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="please enter the number of items you want\nformat: ``.shop <item> <number>``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.reply(embed=Finthechat, mention_author = False)
            ...
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="please enter a valid amount to gamble with\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.reply(embed=Finthechat, mention_author = False)
        else:
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="please enter the necessary arguments\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=Finthechat)
        ...
        if ctx.command.name == "purge":
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="I'm missing the manage messages permission!\n_ _\n**Check the following:**\nAurora BOT Role permissions\nChannel permissions\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=Finthechat)
        else:
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="I'm missing the manage messages permission!\n_ _\n**Check the following:**\nAurora BOT Role permissions\nChannel permissions\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        ...
        if ctx.command.name == "perm":
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="The output was more than 2000 characters, maybe try shortening your argument\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=Finthechat)
        ...
        if ctx.command.name == "perm":
            Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
            Finthechat.add_field(name="Error", value="Space the numbers and try again\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=Finthechat)
...
vb = "<a:9358vibedance:827049139463258153>"
ww = "<a:7250umwtf:827049137580015617>"

xp = "<:auroraxp:835042919793688647>"
coin = "<:a_coin:845896591641411625>"

dpe = "<:durabilitypotion:835761213307748383>"
hpe = "<:healthpotion:835760441732235284>"
vpe = "<:vigourpotion:835760905262202880>"
dash = "<:auroradash:835765195216257054>"
qge = "<:qgun:844452209029677066>"
ebe = "<:ebazooka:844452208842113035>"
ame = "<:aurora_molecule:844217688293507073>"
woe = "<:witchs_orb:844221988419534869>"
ate = "<:a_attack:845895449918570516>"
dfe = "<:a_shield:845895450065502238>"
hae = "<:a_heart:845895449910312990>"
mbe = "<:a_mysterybox:849172705437417482>"
...
async def shop_info(ctx, message):
    if message.lower() == "dp":
        ...
        Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
        Finthechat.add_field(name="Error", value="please enter a valid item's ID to get more information on it\nFormat: ``.shop info <id>``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.reply(embed=Finthechat, mention_author = False)
...
async def buy(ctx):
    Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
    Finthechat.add_field(name="Error", value="please enter a valid amount and a valid ID to buy an item\nFormat: ``.buy <item id> <amount>``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
    await ctx.reply(embed=Finthechat, mention_author = False)       
...
async def buy_dp(ctx, *, message):
    try:
        ...
        Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
        Finthechat.add_field(name="Error", value="please enter a valid amount of the item you're trying to buy \nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.reply(embed=Finthechat, mention_author = False)
...
async def use(ctx):
    Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
    Finthechat.add_field(name="Error", value="please enter a valid ID to use an item\nFormat: ``.use <item id> <quantity>``\n``quantity`` doesnt apply for these items: ``orb``, ``box``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
    await ctx.reply(embed=Finthechat, mention_author = False) 
...
async def use_dp(ctx, *, message):
    try:
        ...
        Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
        Finthechat.add_field(name="Error", value="please enter a valid amount of the item you're trying to use \nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.reply(embed=Finthechat, mention_author = False)
...
async def slots(ctx, *, message):
    ...
    try:
        ...
        Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
        Finthechat.add_field(name="Error", value="Please enter a valid amount\nrun ``.slots info`` for more information\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.send(embed=Finthechat)
...
async def memories(ctx):
    mem = discord.Embed(title="MEMORIES", description="Be grateful about everything, accept the sadness\nand move on, remember everything!", color=0xf7f7f7)
    mem.add_field(name="``.2020``", value="year 2020,  a crisis", inline=False)
    mem.add_field(name="``.2021``", value="year 2021,  a hope", inline=False)
    mem.set_image(url="https://media.discordapp.net/attachments/807511480878497806/829624717023248404/Untitled_design4.png")
    mem.set_footer(text="*Summary here refers to: all world happenings in a nutshell*")
    await ctx.send(embed=mem)

@bot.command(name="2020")
async def twenty_twenty(ctx):
    mem = discord.Embed(title="2020", description="It was by far one of the most difficult years for everyone\nCOVID - 19 had caused many hardships.", color=random.choice(colors))
    mem.add_field(name="_ _", value="--------------------------------------------------------------------", inline=False)
    mem.add_field(name="January - Kobe", value="It was the worst possible news we could have ever gotten.\nHe will not be forgotten", inline=False)
    mem.add_field(name="February - Disasters ", value="feb saw several environmental disasters", inline=False)
    mem.add_field(name="March - COVID - 19 ", value="worsens across the world especially Italy", inline=False)
    mem.add_field(name="April - Asteroid ", value="Asteroid which flew past close to Earth", inline=False)
    mem.add_field(name="May - COVID - 19", value="worsens again", inline=False)
    mem.add_field(name="August - Disasters ", value="Aug saw several environmental disasters", inline=False)
    mem.add_field(name="October - COVID - 19 ", value="COVID worsens again!", inline=False)
    mem.add_field(name="November - COVID - 19 ", value="Widely Controlled! but not completely", inline=False)
    mem.add_field(name="December - NA ", value="nothing major but we finally go through 2020 and survived!", inline=False)
    mem.add_field(name="_ _", value="--------------------------------------------------------------------",inline=False)
    mem.set_footer(text="(Only months which had major events) We must be grateful to survive through this 🤝")
    mem.timestamp = datetime.datetime.utcnow()
    await ctx.send(embed=mem)

@bot.command(name="2021")
async def twenty_twenty_one(ctx):
    mem = discord.Embed(title="2021",description="It came as a ray of hope to fight COVID - 19", color=random.choice(colors))
    mem.add_field(name="_ _", value="--------------------------------------------------------------------", inline=False)
    mem.add_field(name="January - Vaccine", value="The Vaccine was announced for the Public (45 yrs above)", inline=False)
    mem.add_field(name="February - Response ", value="worldwide response towards COVID", inline=False)
    mem.add_field(name="March - COVID - 19", value="It worsens Again!", inline=False)
...
async def oddeven(ctx, *, message):
    ...
    if message != "odd" or "even":
        Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
        Finthechat.add_field(name="Error", value="please enter a valid choice: ``odd`` or ``even``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.send(embed=Finthechat)
...
async def findnum(ctx, *, message):
    ...
    try:
        ...
        Finthechat = discord.Embed(title=" ", description=" ", color=0xffb12b)
        Finthechat.add_field(name="Error", value="please enter a valid number between ``1`` to ``10``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.send(embed=Finthechat)

@bot.command()
@commands.cooldown(1, 30, commands.BucketType.user)
async def hack(ctx, user: discord.Member = None):
    bruh = ["Bumfuzzle", "Cattywampus", "Gardyloo", "Taradiddle", "Snickersnee", "Widdershins", "Collywobbles", "Gubbins"]
    if user == None:
        user = ctx.author
