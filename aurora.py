...
import datetime
import time
from lists import colors, riddles, ball, ball_arg, roasts, rp, vb, ww, xp, coin, dpe, hpe, vpe, dash, qge, ebe, ame, woe, ate, dfe, hae, mbe
...
async def on_command_error(ctx, error):
    ...
    if isinstance(error, commands.MissingPermissions):
        ...
        errormsg.add_field(name="Error", value="Please mention a user\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        await ctx.send(embed=errormsg)
    elif isinstance(error, commands.MissingRequiredArgument):
        if ctx.command.name == "findnum":
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="please enter a valid number between 1 to 10 (not decimal)\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=errormsg)
        elif ctx.command.name == "8ball":
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="please type down a message after the ``.8ball``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.reply(embed=errormsg, mention_author = False)
        elif ctx.command.name == "dp":
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="please enter the number of items you want\nformat: ``.shop <item> <number>``\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.reply(embed=errormsg, mention_author = False)
            ...
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="please enter a valid amount to gamble with\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.reply(embed=errormsg, mention_author = False)
        else:
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="please enter the necessary arguments\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=errormsg)
        ...
        if ctx.command.name == "purge":
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="I'm missing the manage messages permission!\n_ _\n**Check the following:**\nAurora BOT Role permissions\nChannel permissions\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=errormsg)
        else:
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="I'm missing the manage messages permission!\n_ _\n**Check the following:**\nAurora BOT Role permissions\nChannel permissions\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
        ...
        if ctx.command.name == "perm":
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="The output was more than 2000 characters, maybe try shortening your argument\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=errormsg)
        ...
        if ctx.command.name == "perm":
            errormsg = discord.Embed(title=" ", Description=" ", color=0xffb12b)
            errormsg.add_field(name="Error", value="Space the numbers and try again\nSupport Server: [Join!](https://discord.gg/G9vTrsV4aG)")
            await ctx.send(embed=errormsg)
